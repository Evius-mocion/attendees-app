    ...
    return (
        <Menu >
            ...
            <Menu.Dropdown>
                ...
                <Menu.Item leftSection={<IconSettings style={{ width: rem(14), height: rem(14) }} />} onClick={() => setAction('')}>
                    Ingreso
                </Menu.Item>
                <Menu.Item leftSection={<IconSettings style={{ width: rem(14), height: rem(14) }} />} onClick={() => setAction('register')}>
                    Registro
                </Menu.Item>
                ...
                <Menu.Item leftSection={<IconSettings style={{ width: rem(14), height: rem(14) }} />} /* onClick={() => setAction('experience')} */>
                    Ingreso
                </Menu.Item>
